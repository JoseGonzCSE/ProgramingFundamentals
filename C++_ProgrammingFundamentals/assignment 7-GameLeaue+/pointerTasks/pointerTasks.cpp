// Jose Gonzalez assignment 7 Pointer Tasks
...
// 11. Write a function with the following signature: void noNegatives(int *x). The function should accept the address of an int variable. 
...
/*
[jgonz337@hills ~]$ [jgonz337@hills ~]$ g++ point.cpp
